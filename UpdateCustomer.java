...
public class UpdateCustomer extends JFrame implements ActionListener {
    ...
    JComboBox comboid;
    JTextField tfnumber, tfname, tfcountry, tfaddress, tfcontact, tfemail, tfid, tfgender
    ...
    UpdateCustomer(String username) {
        ...
        image.setBounds(400, 100, 450, 350);
        add(image);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Connect c = new Connect();
                String query = "update customers set username ='" + username + "',id='" + id + "',number='"
                        + number
                ...
                JOptionPane.showMessageDialog(null, "Custommer Detail Updated Successfully");
                setVisible(false);
